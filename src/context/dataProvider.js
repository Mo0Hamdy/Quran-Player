  ...
  const recitersData = [
    {
      ...
      img: process.env.PUBLIC_URL + "/images/Mashary.jpeg",
      id: uuidv4(),
      Index: 0,
      surahName: surah[0],
    ...
    },
    {
      ...
      img: process.env.PUBLIC_URL + "/images/Banna.jpeg",
      Index: 0,
      id: uuidv4(),
      surahName: surah[0],
...

    {
      ...
      img: process.env.PUBLIC_URL + "/images/Ayoub.jpeg",
      Index: 0,
      id: uuidv4(),
      surahName: surah[0],
    ...
    },
    {
      ...
      img: process.env.PUBLIC_URL + "/images/Mostafa.jpeg",
      Index: 0,
      id: uuidv4(),
      surahName: surah[0],
